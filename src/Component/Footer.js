...
import '../staticFile/footer.css'
import img1 from '../staticFile/img/images.png'
        ...
        <div className="container">
          <div className="row row-30">
            <div className="col-md-4 col-xl-5">
              <div className="pr-xl-4"><a className="brand" href="index.html"><img className="brand-logo-light" src={img1} alt="LOGO" width="140" height="37" srcSet="images/agency/logo-retina-inverse-280x74.png 2x"/></a>
            ...
            <div className="col-md-4">
              ...
              <dl className="contact-list">
                <dt>phones:</dt>
                <dd><a href="/">https://karosearch.com</a> <span>or</span> <a href="/">https://karosearch.com</a>
                </dd>
              </dl>
            </div>
